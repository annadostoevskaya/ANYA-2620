...
Procedure CreateComponentSOT23_3P65_222X100L35X30N(Zero : integer);
Var
...
Begin
    Try
        ...
        NewPcbLibComp := CreateAComponent('SOT23-3P65_222X100L35X30N');
        NewPcbLibComp.Name := 'SOT23-3P65_222X100L35X30N';
        NewPCBLibComp.Description := 'Small Outline Transistor, SOT-23 Type, 0.65 mm pitch; 3 pin, 2.00 mm L X 1.25 mm W X 1.00 mm H body';
        ...
        TextObj2.Size := MMsToCoord(0.87);
        TextObj2.Width := MMsToCoord(0.09);
        ...
        CreateSMDComponentPad(NewPCBLibComp, '1', eTopLayer, -0.65, -1.05, 0, 0, eRoundedRectangular, 0.75, 0.48, 270, 41.67, 0, 0, True, True);
        CreateSMDComponentPad(NewPCBLibComp, '2', eTopLayer, 0.65, -1.05, 0, 0, eRoundedRectangular, 0.75, 0.48, 270, 41.67, 0, 0, True, True);
        CreateSMDComponentPad(NewPCBLibComp, '3', eTopLayer, 0, 1.05, 0, 0, eRoundedRectangular, 0.75, 0.48, 90, 41.67, 0, 0, True, True);

        CreateComponentTrack(NewPCBLibComp, -0.8, -0.7575, -0.5, -0.7575, ILayer.MechanicalLayer(21), 0.025, False);
        CreateComponentTrack(NewPCBLibComp, -0.5, -0.7575, -0.5, -1.1125, ILayer.MechanicalLayer(21), 0.025, False);
        CreateComponentTrack(NewPCBLibComp, -0.5, -1.1125, -0.8, -1.1125, ILayer.MechanicalLayer(21), 0.025, False);
        CreateComponentTrack(NewPCBLibComp, -0.8, -1.1125, -0.8, -0.7575, ILayer.MechanicalLayer(21), 0.025, False);
        CreateComponentTrack(NewPCBLibComp, 0.5, -0.7575, 0.8, -0.7575, ILayer.MechanicalLayer(21), 0.025, False);
        CreateComponentTrack(NewPCBLibComp, 0.8, -0.7575, 0.8, -1.1125, ILayer.MechanicalLayer(21), 0.025, False);
        CreateComponentTrack(NewPCBLibComp, 0.8, -1.1125, 0.5, -1.1125, ILayer.MechanicalLayer(21), 0.025, False);
        CreateComponentTrack(NewPCBLibComp, 0.5, -1.1125, 0.5, -0.7575, ILayer.MechanicalLayer(21), 0.025, False);
        CreateComponentTrack(NewPCBLibComp, 0.15, 0.7575, -0.15, 0.7575, ILayer.MechanicalLayer(21), 0.025, False);
        CreateComponentTrack(NewPCBLibComp, -0.15, 0.7575, -0.15, 1.1125, ILayer.MechanicalLayer(21), 0.025, False);
        CreateComponentTrack(NewPCBLibComp, -0.15, 1.1125, 0.15, 1.1125, ILayer.MechanicalLayer(21), 0.025, False);
        CreateComponentTrack(NewPCBLibComp, 0.15, 1.1125, 0.15, 0.7575, ILayer.MechanicalLayer(21), 0.025, False);
        CreateComponentTrack(NewPCBLibComp, -1, -0.625, -1, 0.625, ILayer.MechanicalLayer(21), 0.025, False);
        CreateComponentTrack(NewPCBLibComp, -1, 0.625, 1, 0.625, ILayer.MechanicalLayer(21), 0.025, False);
        CreateComponentTrack(NewPCBLibComp, 1, 0.625, 1, -0.625, ILayer.MechanicalLayer(21), 0.025, False);
        CreateComponentTrack(NewPCBLibComp, 1, -0.625, -1, -0.625, ILayer.MechanicalLayer(21), 0.025, False);
        CreateComponentTrack(NewPCBLibComp, 0.185, -0.75, -0.185, -0.75, eTopOverlay, 0.15, False);
        CreateComponentTrack(NewPCBLibComp, 1.175, 0.75, 1.175, -0.75, eTopOverlay, 0.15, False);
        CreateComponentTrack(NewPCBLibComp, 0.465, 0.75, 1.175, 0.75, eTopOverlay, 0.15, False);
        CreateComponentArc(NewPCBLibComp, -1.29, -1.175, 0.125, 0, 360, eTopOverlay, 0.25, False);
        ...
        CreateComponentTrack(NewPCBLibComp, 1.1, -0.675, -0.65, -0.675, eMechanical9, 0.12, False);
        CreateComponentTrack(NewPCBLibComp, -0.65, -0.675, -1.1, -0.225, eMechanical9, 0.12, False);
        CreateComponentTrack(NewPCBLibComp, -1.1, -0.225, -1.1, 0.675, eMechanical9, 0.12, False);
        CreateComponentTrack(NewPCBLibComp, -1.1, 0.675, 1.1, 0.675, eMechanical9, 0.12, False);
        CreateComponentTrack(NewPCBLibComp, 1.1, 0.675, 1.1, -0.675, eMechanical9, 0.12, False);
        CreateComponentTrack(NewPCBLibComp, -1.175, -0.75, -1.175, 0.75, eTopOverlay, 0.15, False);
        CreateComponentTrack(NewPCBLibComp, -1.175, 0.75, -0.465, 0.75, eTopOverlay, 0.15, False);
        CreateComponentTrack(NewPCBLibComp, 1.3, -0.875, 1.3, 0.875, eMechanical15, 0.05, False);
        CreateComponentTrack(NewPCBLibComp, 1.3, 0.875, 0.44, 0.875, eMechanical15, 0.05, False);
        CreateComponentTrack(NewPCBLibComp, 0.44, 0.875, 0.44, 1.625, eMechanical15, 0.05, False);
        CreateComponentTrack(NewPCBLibComp, 0.44, 1.625, -0.44, 1.625, eMechanical15, 0.05, False);
        CreateComponentTrack(NewPCBLibComp, -0.44, 1.625, -0.44, 0.875, eMechanical15, 0.05, False);
        CreateComponentTrack(NewPCBLibComp, -0.44, 0.875, -1.3, 0.875, eMechanical15, 0.05, False);
        CreateComponentTrack(NewPCBLibComp, -1.3, 0.875, -1.3, -0.875, eMechanical15, 0.05, False);
        CreateComponentTrack(NewPCBLibComp, -1.3, -0.875, -1.09, -0.875, eMechanical15, 0.05, False);
        CreateComponentTrack(NewPCBLibComp, -1.09, -0.875, -1.09, -1.625, eMechanical15, 0.05, False);
        CreateComponentTrack(NewPCBLibComp, -1.09, -1.625, 1.09, -1.625, eMechanical15, 0.05, False);
        CreateComponentTrack(NewPCBLibComp, 1.09, -1.625, 1.09, -0.875, eMechanical15, 0.05, False);
        CreateComponentTrack(NewPCBLibComp, 1.09, -0.875, 1.3, -0.875, eMechanical15, 0.05, False);
...
Begin
    ...
    CreateComponentSOT23_3P65_222X100L35X30N(0);
