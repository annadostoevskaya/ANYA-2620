...
Procedure CreateComponentTE_1825910_6(Zero : integer);
Var
...
Begin
    Try
        ...
        NewPcbLibComp := CreateAComponent('TE_1825910-6');
        NewPcbLibComp.Name := 'TE_1825910-6';
        NewPCBLibComp.Description := 'Switches Tactile Switches; 4 pin, 5.99 mm L X 5.99 mm W X 5.00 mm H body';
        NewPCBLibComp.Height := MMsToCoord(5);
        ...
        CreateTHComponentPad(NewPCBLibComp, '1', eRoundHole, 1, 0, eBottomLayer, 3.25, 2.25, 0, 0, eRounded, 1.6, 1.6, eRounded, 1.6, 1.6, eRounded, 1.6, 1.6, 0, 0, -1.6, 0.05, True);
        CreateTHComponentPad(NewPCBLibComp, '2', eRoundHole, 1, 0, eBottomLayer, 3.25, -2.25, 0, 0, eRounded, 1.6, 1.6, eRounded, 1.6, 1.6, eRounded, 1.6, 1.6, 0, 0, -1.6, 0.05, True);
        CreateTHComponentPad(NewPCBLibComp, '3', eRoundHole, 1, 0, eBottomLayer, -3.25, 2.25, 0, 0, eRounded, 1.6, 1.6, eRounded, 1.6, 1.6, eRounded, 1.6, 1.6, 0, 0, -1.6, 0.05, True);
        CreateTHComponentPad(NewPCBLibComp, '4', eRoundHole, 1, 0, eBottomLayer, -3.25, -2.25, 0, 0, eRounded, 1.6, 1.6, eRounded, 1.6, 1.6, eRounded, 1.6, 1.6, 0, 0, -1.6, 0.05, True);

        CreateComponentTrack(NewPCBLibComp, -2.995, -2.995, -2.995, 2.995, ILayer.MechanicalLayer(21), 0.025, False);
        CreateComponentTrack(NewPCBLibComp, -2.995, 2.995, 2.995, 2.995, ILayer.MechanicalLayer(21), 0.025, False);
        CreateComponentTrack(NewPCBLibComp, 2.995, 2.995, 2.995, -2.995, ILayer.MechanicalLayer(21), 0.025, False);
        CreateComponentTrack(NewPCBLibComp, 2.995, -2.995, -2.995, -2.995, ILayer.MechanicalLayer(21), 0.025, False);
        CreateComponentTrack(NewPCBLibComp, -2.995, -2.995, -2.995, 2.995, eMechanical9, 0.12, False);
        CreateComponentTrack(NewPCBLibComp, -2.995, 2.995, 2.995, 2.995, eMechanical9, 0.12, False);
        CreateComponentTrack(NewPCBLibComp, 2.995, 2.995, 2.995, -2.995, eMechanical9, 0.12, False);
        CreateComponentTrack(NewPCBLibComp, 2.995, -2.995, -2.995, -2.995, eMechanical9, 0.12, False);
        CreateComponentTrack(NewPCBLibComp, -2.225, 3.07, 2.225, 3.07, eTopOverlay, 0.15, False);
        CreateComponentTrack(NewPCBLibComp, -2.225, -3.07, 2.225, -3.07, eTopOverlay, 0.15, False);
        CreateComponentTrack(NewPCBLibComp, -3.07, -1.225, -3.07, 1.225, eTopOverlay, 0.15, False);
        CreateComponentTrack(NewPCBLibComp, 3.07, -1.225, 3.07, 1.225, eTopOverlay, 0.15, False);
        ...
        CreateComponentTrack(NewPCBLibComp, -4.3, -3.3, 4.3, -3.3, eMechanical15, 0.05, False);
        CreateComponentTrack(NewPCBLibComp, 4.3, -3.3, 4.3, 3.3, eMechanical15, 0.05, False);
        CreateComponentTrack(NewPCBLibComp, 4.3, 3.3, -4.3, 3.3, eMechanical15, 0.05, False);
        CreateComponentTrack(NewPCBLibComp, -4.3, 3.3, -4.3, -3.3, eMechanical15, 0.05, False);
