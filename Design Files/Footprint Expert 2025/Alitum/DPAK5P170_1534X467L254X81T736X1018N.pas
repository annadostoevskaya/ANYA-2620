...
Procedure CreateComponentDPAK5P170_1534X467L254X81T736X1018N(Zero : integer);
Var
...
Begin
    Try
        ...
        NewPcbLibComp := CreateAComponent('DPAK5P170_1534X467L254X81T736X1018N');
        NewPcbLibComp.Name := 'DPAK5P170_1534X467L254X81T736X1018N';
        NewPCBLibComp.Description := 'DPAK, 1.70 mm pitch; 5 pin, 8.40 mm L X 10.03 mm W X 4.67 mm H body';
        ...
        CreateSMDComponentPad(NewPCBLibComp, '1', eTopLayer, -2.55, -8.098, 0, 0, eRoundedRectangular, 3.66, 1.11, 270, 18.02, 0, 0, True, True);
        CreateSMDComponentPad(NewPCBLibComp, '2', eTopLayer, -0.85, -8.098, 0, 0, eRoundedRectangular, 3.66, 1.11, 270, 18.02, 0, 0, True, True);
        CreateSMDComponentPad(NewPCBLibComp, '3', eTopLayer, 0.85, -8.098, 0, 0, eRoundedRectangular, 3.66, 1.11, 270, 18.02, 0, 0, True, True);
        CreateSMDComponentPad(NewPCBLibComp, '4', eTopLayer, 2.55, -8.098, 0, 0, eRoundedRectangular, 3.66, 1.11, 270, 18.02, 0, 0, True, True);
        CreateSMDComponentPad(NewPCBLibComp, '5', eTopLayer, 0, 2.44, 0, 0, eRoundedRectangular, 7.74, 10.24, 90, 2.58, 0, 0, True, True);

        CreateComponentTrack(NewPCBLibComp, -2.955, -6.94, -2.145, -6.94, ILayer.MechanicalLayer(21), 0.025, False);
        CreateComponentTrack(NewPCBLibComp, -2.145, -6.94, -2.145, -9.48, ILayer.MechanicalLayer(21), 0.025, False);
        CreateComponentTrack(NewPCBLibComp, -2.145, -9.48, -2.955, -9.48, ILayer.MechanicalLayer(21), 0.025, False);
        CreateComponentTrack(NewPCBLibComp, -2.955, -9.48, -2.955, -6.94, ILayer.MechanicalLayer(21), 0.025, False);
        CreateComponentTrack(NewPCBLibComp, -1.255, -6.94, -0.445, -6.94, ILayer.MechanicalLayer(21), 0.025, False);
        CreateComponentTrack(NewPCBLibComp, -0.445, -6.94, -0.445, -9.48, ILayer.MechanicalLayer(21), 0.025, False);
        CreateComponentTrack(NewPCBLibComp, -0.445, -9.48, -1.255, -9.48, ILayer.MechanicalLayer(21), 0.025, False);
        CreateComponentTrack(NewPCBLibComp, -1.255, -9.48, -1.255, -6.94, ILayer.MechanicalLayer(21), 0.025, False);
        CreateComponentTrack(NewPCBLibComp, 0.445, -6.94, 1.255, -6.94, ILayer.MechanicalLayer(21), 0.025, False);
        CreateComponentTrack(NewPCBLibComp, 1.255, -6.94, 1.255, -9.48, ILayer.MechanicalLayer(21), 0.025, False);
        CreateComponentTrack(NewPCBLibComp, 1.255, -9.48, 0.445, -9.48, ILayer.MechanicalLayer(21), 0.025, False);
        CreateComponentTrack(NewPCBLibComp, 0.445, -9.48, 0.445, -6.94, ILayer.MechanicalLayer(21), 0.025, False);
        CreateComponentTrack(NewPCBLibComp, 2.145, -6.94, 2.955, -6.94, ILayer.MechanicalLayer(21), 0.025, False);
        CreateComponentTrack(NewPCBLibComp, 2.955, -6.94, 2.955, -9.48, ILayer.MechanicalLayer(21), 0.025, False);
        CreateComponentTrack(NewPCBLibComp, 2.955, -9.48, 2.145, -9.48, ILayer.MechanicalLayer(21), 0.025, False);
        CreateComponentTrack(NewPCBLibComp, 2.145, -9.48, 2.145, -6.94, ILayer.MechanicalLayer(21), 0.025, False);
        ...
        CreateComponentArc(NewPCBLibComp, -3.505, -9.678, 0.125, 0, 360, eTopOverlay, 0.25, False);
...
Begin
    ...
    CreateComponentDPAK5P170_1534X467L254X81T736X1018N(0);
