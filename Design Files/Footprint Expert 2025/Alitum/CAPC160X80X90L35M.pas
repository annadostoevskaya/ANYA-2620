...
Procedure CreateComponentCAPC160X80X90L35M(Zero : integer);
Var
...
Begin
    Try
        ...
        NewPcbLibComp := CreateAComponent('CAPC160X80X90L35M');
        NewPcbLibComp.Name := 'CAPC160X80X90L35M';
        NewPCBLibComp.Description := 'Capacitor, Chip; 1.60 mm L X 0.80 mm W X 0.90 mm H body';
        NewPCBLibComp.Height := MMsToCoord(0.9);
        ...
        TextObj2.Size := MMsToCoord(0.5);
        TextObj2.Width := MMsToCoord(0.05);
        ...
        CreateSMDComponentPad(NewPCBLibComp, '1', eTopLayer, -0.791, 0, 0, 0, eRoundedRectangular, 0.92, 1, 180, 21.74, 0, 0, True, True);
        CreateSMDComponentPad(NewPCBLibComp, '2', eTopLayer, 0.791, 0, 0, 0, eRoundedRectangular, 0.92, 1, 0, 21.74, 0, 0, True, True);

        CreateComponentTrack(NewPCBLibComp, -0.45, 0.4, -0.45, -0.4, ILayer.MechanicalLayer(21), 0.025, False);
        CreateComponentTrack(NewPCBLibComp, -0.45, -0.4, -0.8, -0.4, ILayer.MechanicalLayer(21), 0.025, False);
        CreateComponentTrack(NewPCBLibComp, -0.8, -0.4, -0.8, 0.4, ILayer.MechanicalLayer(21), 0.025, False);
        CreateComponentTrack(NewPCBLibComp, -0.8, 0.4, -0.45, 0.4, ILayer.MechanicalLayer(21), 0.025, False);
        CreateComponentTrack(NewPCBLibComp, 0.45, -0.4, 0.45, 0.4, ILayer.MechanicalLayer(21), 0.025, False);
        CreateComponentTrack(NewPCBLibComp, 0.45, 0.4, 0.8, 0.4, ILayer.MechanicalLayer(21), 0.025, False);
        CreateComponentTrack(NewPCBLibComp, 0.8, 0.4, 0.8, -0.4, ILayer.MechanicalLayer(21), 0.025, False);
        CreateComponentTrack(NewPCBLibComp, 0.8, -0.4, 0.45, -0.4, ILayer.MechanicalLayer(21), 0.025, False);
        ...
        CreateComponentTrack(NewPCBLibComp, 0.8, 0.4, 0.8, -0.4, ILayer.MechanicalLayer(21), 0.025, False);
        CreateComponentTrack(NewPCBLibComp, 0.8, -0.4, -0.8, -0.4, ILayer.MechanicalLayer(21), 0.025, False);
        CreateComponentTrack(NewPCBLibComp, -0.85, -0.45, -0.85, 0.45, eMechanical9, 0.12, False);
        CreateComponentTrack(NewPCBLibComp, -0.85, 0.45, 0.85, 0.45, eMechanical9, 0.12, False);
        CreateComponentTrack(NewPCBLibComp, 0.85, 0.45, 0.85, -0.45, eMechanical9, 0.12, False);
        CreateComponentTrack(NewPCBLibComp, 0.85, -0.45, -0.85, -0.45, eMechanical9, 0.12, False);
        CreateComponentTrack(NewPCBLibComp, -1.651, -0.9, -1.651, 0.9, eMechanical15, 0.05, False);
        CreateComponentTrack(NewPCBLibComp, -1.651, 0.9, 1.651, 0.9, eMechanical15, 0.05, False);
        CreateComponentTrack(NewPCBLibComp, 1.651, 0.9, 1.651, -0.9, eMechanical15, 0.05, False);
        CreateComponentTrack(NewPCBLibComp, 1.651, -0.9, -1.651, -0.9, eMechanical15, 0.05, False);
        ...
        CreateComponentTrack(NewPCBLibComp, -0.517, -0.8, -1.55, -0.8, eTopOverlay, 0.2, False);
        CreateComponentTrack(NewPCBLibComp, -1.55, -0.8, -1.55, 0.8, eTopOverlay, 0.2, False);
        CreateComponentTrack(NewPCBLibComp, -1.55, 0.8, -0.517, 0.8, eTopOverlay, 0.2, False);
        CreateComponentTrack(NewPCBLibComp, 0.517, -0.8, 1.55, -0.8, eTopOverlay, 0.2, False);
        CreateComponentTrack(NewPCBLibComp, 1.55, -0.8, 1.55, 0.8, eTopOverlay, 0.2, False);
        CreateComponentTrack(NewPCBLibComp, 1.55, 0.8, 0.517, 0.8, eTopOverlay, 0.2, False);
...
Begin
    ...
    CreateComponentCAPC160X80X90L35M(0);
