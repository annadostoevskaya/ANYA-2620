...
Procedure CreateComponentXTAL1140X480X380L1X80N(Zero : integer);
Var
...
Begin
    Try
        ...
        NewPcbLibComp := CreateAComponent('XTAL1140X480X380L1X80N');
        NewPcbLibComp.Name := 'XTAL1140X480X380L1X80N';
        NewPCBLibComp.Description := 'SMD Crystal; 11.40 mm L X 4.80 mm W X 3.80 mm H body';
        NewPCBLibComp.Height := MMsToCoord(3.8);
        ...
        CreateSMDComponentPad(NewPCBLibComp, '1', eTopLayer, -4.938, 0, 0, 0, eRoundedRectangular, 5, 1.8, 180, 11.11, 0, 0, True, True);
        CreateSMDComponentPad(NewPCBLibComp, '2', eTopLayer, 4.938, 0, 0, 0, eRoundedRectangular, 5, 1.8, 0, 11.11, 0, 0, True, True);
        ...
        CreateComponentTrack(NewPCBLibComp, 6.94, 0.4, 6.94, -0.4, ILayer.MechanicalLayer(21), 0.025, False);
        CreateComponentTrack(NewPCBLibComp, 6.94, -0.4, 2.44, -0.4, ILayer.MechanicalLayer(21), 0.025, False);
        CreateComponentTrack(NewPCBLibComp, -5.7, -2.4, -5.7, 2.4, ILayer.MechanicalLayer(21), 0.025, False);
        CreateComponentTrack(NewPCBLibComp, -5.7, 2.4, 5.7, 2.4, ILayer.MechanicalLayer(21), 0.025, False);
        CreateComponentTrack(NewPCBLibComp, 5.7, 2.4, 5.7, -2.4, ILayer.MechanicalLayer(21), 0.025, False);
        CreateComponentTrack(NewPCBLibComp, 5.7, -2.4, -5.7, -2.4, ILayer.MechanicalLayer(21), 0.025, False);
        CreateComponentTrack(NewPCBLibComp, -5.75, -2.405, -5.75, 2.405, eMechanical9, 0.12, False);
        CreateComponentTrack(NewPCBLibComp, -5.75, 2.405, 5.75, 2.405, eMechanical9, 0.12, False);
        CreateComponentTrack(NewPCBLibComp, 5.75, 2.405, 5.75, -2.405, eMechanical9, 0.12, False);
        CreateComponentTrack(NewPCBLibComp, 5.75, -2.405, -5.75, -2.405, eMechanical9, 0.12, False);
        ...
        CreateComponentTrack(NewPCBLibComp, 5.825, 1.125, 5.825, 2.48, eTopOverlay, 0.15, False);
        CreateComponentTrack(NewPCBLibComp, 5.825, 2.48, -5.825, 2.48, eTopOverlay, 0.15, False);
        CreateComponentTrack(NewPCBLibComp, -5.825, 2.48, -5.825, 1.125, eTopOverlay, 0.15, False);
        CreateComponentTrack(NewPCBLibComp, 5.825, -1.125, 5.825, -2.48, eTopOverlay, 0.15, False);
        CreateComponentTrack(NewPCBLibComp, 5.825, -2.48, -5.825, -2.48, eTopOverlay, 0.15, False);
        CreateComponentTrack(NewPCBLibComp, -5.825, -2.48, -5.825, -1.125, eTopOverlay, 0.15, False);
        CreateComponentTrack(NewPCBLibComp, -5.95, -2.605, 5.95, -2.605, eMechanical15, 0.05, False);
        CreateComponentTrack(NewPCBLibComp, 5.95, -2.605, 5.95, -1.1, eMechanical15, 0.05, False);
        CreateComponentTrack(NewPCBLibComp, 5.95, -1.1, 7.638, -1.1, eMechanical15, 0.05, False);
        CreateComponentTrack(NewPCBLibComp, 7.638, -1.1, 7.638, 1.1, eMechanical15, 0.05, False);
        CreateComponentTrack(NewPCBLibComp, 7.638, 1.1, 5.95, 1.1, eMechanical15, 0.05, False);
        CreateComponentTrack(NewPCBLibComp, 5.95, 1.1, 5.95, 2.605, eMechanical15, 0.05, False);
        CreateComponentTrack(NewPCBLibComp, 5.95, 2.605, -5.95, 2.605, eMechanical15, 0.05, False);
        CreateComponentTrack(NewPCBLibComp, -5.95, 2.605, -5.95, 1.1, eMechanical15, 0.05, False);
        CreateComponentTrack(NewPCBLibComp, -5.95, 1.1, -7.638, 1.1, eMechanical15, 0.05, False);
        CreateComponentTrack(NewPCBLibComp, -7.638, 1.1, -7.638, -1.1, eMechanical15, 0.05, False);
...
Begin
    ...
    CreateComponentXTAL1140X480X380L1X80N(0);
