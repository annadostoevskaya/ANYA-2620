...
Procedure CreateComponentHDRV16W64P254_16X1_1580X250H850(Zero : integer);
Var
...
Begin
    Try
        ...
        NewPcbLibComp := CreateAComponent('HDRV16W64P254_16X1_1580X250H850');
        NewPcbLibComp.Name := 'HDRV16W64P254_16X1_1580X250H850';
        NewPCBLibComp.Description := 'Header, Vertical Non-Shrouded, 2.54 mm pitch; 0.64 mm lead width, 16 pin, 1 row, 15.80 mm L X 2.50 mm W X 8.50 mm H body';
        NewPCBLibComp.Height := MMsToCoord(8.5);
        ...
        CreateTHComponentPad(NewPCBLibComp, '1', eRoundHole, 1.05, 0, eBottomLayer, -19.05, 0, 0, 0, eRectangular, 1.58, 1.58, eRounded, 1.58, 1.58, eRectangular, 1.58, 1.58, 0, 0, -1.58, 0, True);
        CreateTHComponentPad(NewPCBLibComp, '2', eRoundHole, 1.05, 0, eBottomLayer, -16.51, 0, 0, 0, eRounded, 1.58, 1.58, eRounded, 1.58, 1.58, eRounded, 1.58, 1.58, 0, 0, -1.58, 0, True);
        CreateTHComponentPad(NewPCBLibComp, '3', eRoundHole, 1.05, 0, eBottomLayer, -13.97, 0, 0, 0, eRounded, 1.58, 1.58, eRounded, 1.58, 1.58, eRounded, 1.58, 1.58, 0, 0, -1.58, 0, True);
        CreateTHComponentPad(NewPCBLibComp, '4', eRoundHole, 1.05, 0, eBottomLayer, -11.43, 0, 0, 0, eRounded, 1.58, 1.58, eRounded, 1.58, 1.58, eRounded, 1.58, 1.58, 0, 0, -1.58, 0, True);
        CreateTHComponentPad(NewPCBLibComp, '5', eRoundHole, 1.05, 0, eBottomLayer, -8.89, 0, 0, 0, eRounded, 1.58, 1.58, eRounded, 1.58, 1.58, eRounded, 1.58, 1.58, 0, 0, -1.58, 0, True);
        CreateTHComponentPad(NewPCBLibComp, '6', eRoundHole, 1.05, 0, eBottomLayer, -6.35, 0, 0, 0, eRounded, 1.58, 1.58, eRounded, 1.58, 1.58, eRounded, 1.58, 1.58, 0, 0, -1.58, 0, True);
        CreateTHComponentPad(NewPCBLibComp, '7', eRoundHole, 1.05, 0, eBottomLayer, -3.81, 0, 0, 0, eRounded, 1.58, 1.58, eRounded, 1.58, 1.58, eRounded, 1.58, 1.58, 0, 0, -1.58, 0, True);
        CreateTHComponentPad(NewPCBLibComp, '8', eRoundHole, 1.05, 0, eBottomLayer, -1.27, 0, 0, 0, eRounded, 1.58, 1.58, eRounded, 1.58, 1.58, eRounded, 1.58, 1.58, 0, 0, -1.58, 0, True);
        CreateTHComponentPad(NewPCBLibComp, '9', eRoundHole, 1.05, 0, eBottomLayer, 1.27, 0, 0, 0, eRounded, 1.58, 1.58, eRounded, 1.58, 1.58, eRounded, 1.58, 1.58, 0, 0, -1.58, 0, True);
        CreateTHComponentPad(NewPCBLibComp, '10', eRoundHole, 1.05, 0, eBottomLayer, 3.81, 0, 0, 0, eRounded, 1.58, 1.58, eRounded, 1.58, 1.58, eRounded, 1.58, 1.58, 0, 0, -1.58, 0, True);
        CreateTHComponentPad(NewPCBLibComp, '11', eRoundHole, 1.05, 0, eBottomLayer, 6.35, 0, 0, 0, eRounded, 1.58, 1.58, eRounded, 1.58, 1.58, eRounded, 1.58, 1.58, 0, 0, -1.58, 0, True);
        CreateTHComponentPad(NewPCBLibComp, '12', eRoundHole, 1.05, 0, eBottomLayer, 8.89, 0, 0, 0, eRounded, 1.58, 1.58, eRounded, 1.58, 1.58, eRounded, 1.58, 1.58, 0, 0, -1.58, 0, True);
        CreateTHComponentPad(NewPCBLibComp, '13', eRoundHole, 1.05, 0, eBottomLayer, 11.43, 0, 0, 0, eRounded, 1.58, 1.58, eRounded, 1.58, 1.58, eRounded, 1.58, 1.58, 0, 0, -1.58, 0, True);
        CreateTHComponentPad(NewPCBLibComp, '14', eRoundHole, 1.05, 0, eBottomLayer, 13.97, 0, 0, 0, eRounded, 1.58, 1.58, eRounded, 1.58, 1.58, eRounded, 1.58, 1.58, 0, 0, -1.58, 0, True);
        CreateTHComponentPad(NewPCBLibComp, '15', eRoundHole, 1.05, 0, eBottomLayer, 16.51, 0, 0, 0, eRounded, 1.58, 1.58, eRounded, 1.58, 1.58, eRounded, 1.58, 1.58, 0, 0, -1.58, 0, True);
        CreateTHComponentPad(NewPCBLibComp, '16', eRoundHole, 1.05, 0, eBottomLayer, 19.05, 0, 0, 0, eRounded, 1.58, 1.58, eRounded, 1.58, 1.58, eRounded, 1.58, 1.58, 0, 0, -1.58, 0, True);

        CreateComponentTrack(NewPCBLibComp, -19.37, -0.32, -19.37, 0.32, ILayer.MechanicalLayer(21), 0.025, False);
        CreateComponentTrack(NewPCBLibComp, -19.37, 0.32, -18.73, 0.32, ILayer.MechanicalLayer(21), 0.025, False);
        CreateComponentTrack(NewPCBLibComp, -18.73, 0.32, -18.73, -0.32, ILayer.MechanicalLayer(21), 0.025, False);
        CreateComponentTrack(NewPCBLibComp, -18.73, -0.32, -19.37, -0.32, ILayer.MechanicalLayer(21), 0.025, False);
        CreateComponentTrack(NewPCBLibComp, -16.83, -0.32, -16.83, 0.32, ILayer.MechanicalLayer(21), 0.025, False);
        CreateComponentTrack(NewPCBLibComp, -16.83, 0.32, -16.19, 0.32, ILayer.MechanicalLayer(21), 0.025, False);
        CreateComponentTrack(NewPCBLibComp, -16.19, 0.32, -16.19, -0.32, ILayer.MechanicalLayer(21), 0.025, False);
        CreateComponentTrack(NewPCBLibComp, -16.19, -0.32, -16.83, -0.32, ILayer.MechanicalLayer(21), 0.025, False);
        CreateComponentTrack(NewPCBLibComp, -14.29, -0.32, -14.29, 0.32, ILayer.MechanicalLayer(21), 0.025, False);
        CreateComponentTrack(NewPCBLibComp, -14.29, 0.32, -13.65, 0.32, ILayer.MechanicalLayer(21), 0.025, False);
        CreateComponentTrack(NewPCBLibComp, -13.65, 0.32, -13.65, -0.32, ILayer.MechanicalLayer(21), 0.025, False);
        CreateComponentTrack(NewPCBLibComp, -13.65, -0.32, -14.29, -0.32, ILayer.MechanicalLayer(21), 0.025, False);
        CreateComponentTrack(NewPCBLibComp, -11.75, -0.32, -11.75, 0.32, ILayer.MechanicalLayer(21), 0.025, False);
        CreateComponentTrack(NewPCBLibComp, -11.75, 0.32, -11.11, 0.32, ILayer.MechanicalLayer(21), 0.025, False);
        CreateComponentTrack(NewPCBLibComp, -11.11, 0.32, -11.11, -0.32, ILayer.MechanicalLayer(21), 0.025, False);
        CreateComponentTrack(NewPCBLibComp, -11.11, -0.32, -11.75, -0.32, ILayer.MechanicalLayer(21), 0.025, False);
        CreateComponentTrack(NewPCBLibComp, -9.21, -0.32, -9.21, 0.32, ILayer.MechanicalLayer(21), 0.025, False);
        CreateComponentTrack(NewPCBLibComp, -9.21, 0.32, -8.57, 0.32, ILayer.MechanicalLayer(21), 0.025, False);
        CreateComponentTrack(NewPCBLibComp, -8.57, 0.32, -8.57, -0.32, ILayer.MechanicalLayer(21), 0.025, False);
        CreateComponentTrack(NewPCBLibComp, -8.57, -0.32, -9.21, -0.32, ILayer.MechanicalLayer(21), 0.025, False);
        CreateComponentTrack(NewPCBLibComp, -6.67, -0.32, -6.67, 0.32, ILayer.MechanicalLayer(21), 0.025, False);
        CreateComponentTrack(NewPCBLibComp, -6.67, 0.32, -6.03, 0.32, ILayer.MechanicalLayer(21), 0.025, False);
        CreateComponentTrack(NewPCBLibComp, -6.03, 0.32, -6.03, -0.32, ILayer.MechanicalLayer(21), 0.025, False);
        CreateComponentTrack(NewPCBLibComp, -6.03, -0.32, -6.67, -0.32, ILayer.MechanicalLayer(21), 0.025, False);
        CreateComponentTrack(NewPCBLibComp, -4.13, -0.32, -4.13, 0.32, ILayer.MechanicalLayer(21), 0.025, False);
        CreateComponentTrack(NewPCBLibComp, -4.13, 0.32, -3.49, 0.32, ILayer.MechanicalLayer(21), 0.025, False);
        CreateComponentTrack(NewPCBLibComp, -3.49, 0.32, -3.49, -0.32, ILayer.MechanicalLayer(21), 0.025, False);
        CreateComponentTrack(NewPCBLibComp, -3.49, -0.32, -4.13, -0.32, ILayer.MechanicalLayer(21), 0.025, False);
        CreateComponentTrack(NewPCBLibComp, -1.59, -0.32, -1.59, 0.32, ILayer.MechanicalLayer(21), 0.025, False);
        CreateComponentTrack(NewPCBLibComp, -1.59, 0.32, -0.95, 0.32, ILayer.MechanicalLayer(21), 0.025, False);
        CreateComponentTrack(NewPCBLibComp, -0.95, 0.32, -0.95, -0.32, ILayer.MechanicalLayer(21), 0.025, False);
        CreateComponentTrack(NewPCBLibComp, -0.95, -0.32, -1.59, -0.32, ILayer.MechanicalLayer(21), 0.025, False);
        CreateComponentTrack(NewPCBLibComp, 0.95, -0.32, 0.95, 0.32, ILayer.MechanicalLayer(21), 0.025, False);
        CreateComponentTrack(NewPCBLibComp, 0.95, 0.32, 1.59, 0.32, ILayer.MechanicalLayer(21), 0.025, False);
        CreateComponentTrack(NewPCBLibComp, 1.59, 0.32, 1.59, -0.32, ILayer.MechanicalLayer(21), 0.025, False);
        CreateComponentTrack(NewPCBLibComp, 1.59, -0.32, 0.95, -0.32, ILayer.MechanicalLayer(21), 0.025, False);
        ...
        CreateComponentTrack(NewPCBLibComp, 19.37, 0.32, 19.37, -0.32, ILayer.MechanicalLayer(21), 0.025, False);
        CreateComponentTrack(NewPCBLibComp, 19.37, -0.32, 18.73, -0.32, ILayer.MechanicalLayer(21), 0.025, False);
        CreateComponentTrack(NewPCBLibComp, -7.9, -1.25, -7.9, 1.25, ILayer.MechanicalLayer(21), 0.025, False);
        CreateComponentTrack(NewPCBLibComp, -7.9, 1.25, 7.9, 1.25, ILayer.MechanicalLayer(21), 0.025, False);
        CreateComponentTrack(NewPCBLibComp, 7.9, 1.25, 7.9, -1.25, ILayer.MechanicalLayer(21), 0.025, False);
        CreateComponentTrack(NewPCBLibComp, 7.9, -1.25, -7.9, -1.25, ILayer.MechanicalLayer(21), 0.025, False);
        CreateComponentTrack(NewPCBLibComp, -7.9, -1.25, -7.9, 1.25, ILayer.MechanicalLayer(21), 0.025, False);
        ...
        CreateComponentTrack(NewPCBLibComp, 7.9, 1.25, 7.9, -1.25, ILayer.MechanicalLayer(21), 0.025, False);
        CreateComponentTrack(NewPCBLibComp, 7.9, -1.25, -7.9, -1.25, ILayer.MechanicalLayer(21), 0.025, False);
        CreateComponentTrack(NewPCBLibComp, -20.065, -1.325, -20.065, 1.325, eTopOverlay, 0.15, False);
        CreateComponentTrack(NewPCBLibComp, -20.065, 1.325, 20.065, 1.325, eTopOverlay, 0.15, False);
        CreateComponentTrack(NewPCBLibComp, 20.065, 1.325, 20.065, -1.325, eTopOverlay, 0.15, False);
        CreateComponentTrack(NewPCBLibComp, 20.065, -1.325, -20.065, -1.325, eTopOverlay, 0.15, False);
        CreateComponentArc(NewPCBLibComp, -20.54, 0, 0.125, 0, 360, eTopOverlay, 0.25, False);
        CreateComponentTrack(NewPCBLibComp, -20.14, -1.575, -20.14, 1.575, eMechanical15, 0.05, False);
        CreateComponentTrack(NewPCBLibComp, -20.14, 1.575, 20.14, 1.575, eMechanical15, 0.05, False);
        CreateComponentTrack(NewPCBLibComp, 20.14, 1.575, 20.14, -1.575, eMechanical15, 0.05, False);
        CreateComponentTrack(NewPCBLibComp, 20.14, -1.575, -20.14, -1.575, eMechanical15, 0.05, False);
        ...
        CreateComponentTrack(NewPCBLibComp, -7.9, 1.25, -7.9, -0.417, eMechanical9, 0.12, False);
        CreateComponentTrack(NewPCBLibComp, -7.9, -0.417, -7.067, -1.25, eMechanical9, 0.12, False);
        CreateComponentTrack(NewPCBLibComp, -7.067, -1.25, 7.9, -1.25, eMechanical9, 0.12, False);
        CreateComponentTrack(NewPCBLibComp, 7.9, -1.25, 7.9, 1.25, eMechanical9, 0.12, False);
        CreateComponentTrack(NewPCBLibComp, 7.9, 1.25, -7.9, 1.25, eMechanical9, 0.12, False);
...
Begin
    ...
    CreateComponentHDRV16W64P254_16X1_1580X250H850(0);
