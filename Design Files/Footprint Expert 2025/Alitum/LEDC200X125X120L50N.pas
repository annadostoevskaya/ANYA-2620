...
Procedure CreateComponentLEDC200X125X120L50N(Zero : integer);
Var
...
Begin
    Try
        ...
        NewPcbLibComp := CreateAComponent('LEDC200X125X120L50N');
        NewPcbLibComp.Name := 'LEDC200X125X120L50N';
        NewPCBLibComp.Description := 'LED, Chip; 2.00 mm L X 1.25 mm W X 1.20 mm H body';
        ...
        CreateSMDComponentPad(NewPCBLibComp, 'C', eTopLayer, -0.882, 0, 0, 0, eRoundedRectangular, 0.94, 1.35, 180, 21.28, 0, 0, True, True);
        CreateSMDComponentPad(NewPCBLibComp, 'A', eTopLayer, 0.882, 0, 0, 0, eRoundedRectangular, 0.94, 1.35, 0, 21.28, 0, 0, True, True);

        CreateComponentTrack(NewPCBLibComp, -0.5, 0.625, -0.5, -0.625, ILayer.MechanicalLayer(21), 0.025, False);
        CreateComponentTrack(NewPCBLibComp, -0.5, -0.625, -1, -0.625, ILayer.MechanicalLayer(21), 0.025, False);
        CreateComponentTrack(NewPCBLibComp, -1, -0.625, -1, 0.625, ILayer.MechanicalLayer(21), 0.025, False);
        CreateComponentTrack(NewPCBLibComp, -1, 0.625, -0.5, 0.625, ILayer.MechanicalLayer(21), 0.025, False);
        CreateComponentTrack(NewPCBLibComp, 0.5, -0.625, 0.5, 0.625, ILayer.MechanicalLayer(21), 0.025, False);
        CreateComponentTrack(NewPCBLibComp, 0.5, 0.625, 1, 0.625, ILayer.MechanicalLayer(21), 0.025, False);
        CreateComponentTrack(NewPCBLibComp, 1, 0.625, 1, -0.625, ILayer.MechanicalLayer(21), 0.025, False);
        CreateComponentTrack(NewPCBLibComp, 1, -0.625, 0.5, -0.625, ILayer.MechanicalLayer(21), 0.025, False);
        ...
        CreateComponentTrack(NewPCBLibComp, 1, 0.625, 1, -0.625, ILayer.MechanicalLayer(21), 0.025, False);
        CreateComponentTrack(NewPCBLibComp, 1, -0.625, -1, -0.625, ILayer.MechanicalLayer(21), 0.025, False);
        CreateComponentTrack(NewPCBLibComp, -1.65, -0.975, -1.65, 0.975, eMechanical15, 0.05, False);
        CreateComponentTrack(NewPCBLibComp, -1.65, 0.975, 1.65, 0.975, eMechanical15, 0.05, False);
        CreateComponentTrack(NewPCBLibComp, 1.65, 0.975, 1.65, -0.975, eMechanical15, 0.05, False);
        CreateComponentTrack(NewPCBLibComp, 1.65, -0.975, -1.65, -0.975, eMechanical15, 0.05, False);
        ...
        CreateComponentTrack(NewPCBLibComp, -1.05, 0.675, -1.05, -0.225, eMechanical9, 0.12, False);
        CreateComponentTrack(NewPCBLibComp, -1.05, -0.225, -0.6, -0.675, eMechanical9, 0.12, False);
        CreateComponentTrack(NewPCBLibComp, -0.6, -0.675, 1.05, -0.675, eMechanical9, 0.12, False);
        CreateComponentTrack(NewPCBLibComp, 1.05, -0.675, 1.05, 0.675, eMechanical9, 0.12, False);
        CreateComponentTrack(NewPCBLibComp, 1.05, 0.675, -1.05, 0.675, eMechanical9, 0.12, False);
        CreateComponentTrack(NewPCBLibComp, -0.525, -0.9, -1.575, -0.9, eTopOverlay, 0.15, False);
        CreateComponentTrack(NewPCBLibComp, -1.575, -0.9, -1.575, 0.9, eTopOverlay, 0.15, False);
        CreateComponentTrack(NewPCBLibComp, -1.575, 0.9, -0.525, 0.9, eTopOverlay, 0.15, False);
        CreateComponentTrack(NewPCBLibComp, 0.525, -0.9, 1.575, -0.9, eTopOverlay, 0.15, False);
        CreateComponentTrack(NewPCBLibComp, 1.575, -0.9, 1.575, 0.9, eTopOverlay, 0.15, False);
        CreateComponentTrack(NewPCBLibComp, 1.575, 0.9, 0.525, 0.9, eTopOverlay, 0.15, False);
...
Begin
    ...
    CreateComponentLEDC200X125X120L50N(0);
