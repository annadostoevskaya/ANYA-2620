...
Procedure CreateComponentKEYSTONE_1060TR(Zero : integer);
Var
...
Begin
    Try
        ...
        NewPcbLibComp := CreateAComponent('KEYSTONE_1060TR');
        NewPcbLibComp.Name := 'KEYSTONE_1060TR';
        NewPCBLibComp.Description := 'Battery / Battery Holders, Clips, Contacts / Keystone 1060TR; 3 pin, 31.90 mm L X 16.00 mm W X 5.51 mm H body';
        NewPCBLibComp.Height := MMsToCoord(5.51);
        ...
        CreateSMDComponentPad(NewPCBLibComp, '1', eTopLayer, -14.655, 0, 0, 0, eRectangular, 2.59, 3.61, 0, 0, 0, 0, True, True);
        CreateSMDComponentPad(NewPCBLibComp, '2', eTopLayer, 14.655, 0, 0, 0, eRectangular, 2.59, 3.61, 0, 0, 0, 0, True, True);
        CreateSMDComponentPad(NewPCBLibComp, 'MP', eTopLayer, 0, 0, 0, 0, eRectangular, 11, 7.01, 0, 0, 0, 0, True, True);

        CreateComponentTrack(NewPCBLibComp, -15.95, -8, -15.95, 8, ILayer.MechanicalLayer(21), 0.025, False);
        CreateComponentTrack(NewPCBLibComp, -15.95, 8, 15.95, 8, ILayer.MechanicalLayer(21), 0.025, False);
        CreateComponentTrack(NewPCBLibComp, 15.95, 8, 15.95, -8, ILayer.MechanicalLayer(21), 0.025, False);
        CreateComponentTrack(NewPCBLibComp, 15.95, -8, -15.95, -8, ILayer.MechanicalLayer(21), 0.025, False);
        CreateComponentTrack(NewPCBLibComp, -15.95, -8, -15.95, 8, eMechanical9, 0.12, False);
        CreateComponentTrack(NewPCBLibComp, -15.95, 8, 15.95, 8, eMechanical9, 0.12, False);
        CreateComponentTrack(NewPCBLibComp, 15.95, 8, 15.95, -8, eMechanical9, 0.12, False);
        CreateComponentTrack(NewPCBLibComp, 15.95, -8, -15.95, -8, eMechanical9, 0.12, False);
        ...
        CreateComponentTrack(NewPCBLibComp, 16.025, -2.03, 16.025, -8.075, eTopOverlay, 0.15, False);
        CreateComponentTrack(NewPCBLibComp, 16.025, -8.075, -16.025, -8.075, eTopOverlay, 0.15, False);
        CreateComponentTrack(NewPCBLibComp, -16.025, -8.075, -16.025, -2.03, eTopOverlay, 0.15, False);
        CreateComponentTrack(NewPCBLibComp, -16.025, 2.03, -16.025, 8.075, eTopOverlay, 0.15, False);
        CreateComponentTrack(NewPCBLibComp, -16.025, 8.075, 16.025, 8.075, eTopOverlay, 0.15, False);
        CreateComponentTrack(NewPCBLibComp, 16.025, 8.075, 16.025, 2.03, eTopOverlay, 0.15, False);
        CreateComponentTrack(NewPCBLibComp, -16.2, -8.25, 16.2, -8.25, eMechanical15, 0.05, False);
        CreateComponentTrack(NewPCBLibComp, 16.2, -8.25, 16.2, 8.25, eMechanical15, 0.05, False);
        CreateComponentTrack(NewPCBLibComp, 16.2, 8.25, -16.2, 8.25, eMechanical15, 0.05, False);
        CreateComponentTrack(NewPCBLibComp, -16.2, 8.25, -16.2, -8.25, eMechanical15, 0.05, False);
...
Begin
    ...
    CreateComponentKEYSTONE_1060TR(0);
