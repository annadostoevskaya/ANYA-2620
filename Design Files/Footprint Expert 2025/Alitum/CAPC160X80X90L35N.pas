...
Procedure CreateComponentCAPC160X80X90L35N(Zero : integer);
Var
...
Begin
    Try
        ...
        NewPcbLibComp := CreateAComponent('CAPC160X80X90L35N');
        NewPcbLibComp.Name := 'CAPC160X80X90L35N';
        ...
        CreateSMDComponentPad(NewPCBLibComp, '1', eTopLayer, -0.741, 0, 0, 0, eRoundedRectangular, 0.82, 0.9, 180, 24.39, 0, 0, True, True);
        CreateSMDComponentPad(NewPCBLibComp, '2', eTopLayer, 0.741, 0, 0, 0, eRoundedRectangular, 0.82, 0.9, 0, 24.39, 0, 0, True, True);
        ...
        CreateComponentTrack(NewPCBLibComp, 0.85, 0.45, 0.85, -0.45, eMechanical9, 0.12, False);
        CreateComponentTrack(NewPCBLibComp, 0.85, -0.45, -0.85, -0.45, eMechanical9, 0.12, False);
        CreateComponentTrack(NewPCBLibComp, -1.45, -0.75, -1.45, 0.75, eMechanical15, 0.05, False);
        CreateComponentTrack(NewPCBLibComp, -1.45, 0.75, 1.45, 0.75, eMechanical15, 0.05, False);
        CreateComponentTrack(NewPCBLibComp, 1.45, 0.75, 1.45, -0.75, eMechanical15, 0.05, False);
        CreateComponentTrack(NewPCBLibComp, 1.45, -0.75, -1.45, -0.75, eMechanical15, 0.05, False);
        ...
        CreateComponentTrack(NewPCBLibComp, -0.458, -0.675, -1.375, -0.675, eTopOverlay, 0.15, False);
        CreateComponentTrack(NewPCBLibComp, -1.375, -0.675, -1.375, 0.675, eTopOverlay, 0.15, False);
        CreateComponentTrack(NewPCBLibComp, -1.375, 0.675, -0.458, 0.675, eTopOverlay, 0.15, False);
        CreateComponentTrack(NewPCBLibComp, 0.458, -0.675, 1.375, -0.675, eTopOverlay, 0.15, False);
        CreateComponentTrack(NewPCBLibComp, 1.375, -0.675, 1.375, 0.675, eTopOverlay, 0.15, False);
        CreateComponentTrack(NewPCBLibComp, 1.375, 0.675, 0.458, 0.675, eTopOverlay, 0.15, False);
...
Begin
    ...
    CreateComponentCAPC160X80X90L35N(0);
