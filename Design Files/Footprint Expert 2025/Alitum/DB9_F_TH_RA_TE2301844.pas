...
Procedure CreateComponentDB9_F_TH_RA_TE2301844(Zero : integer);
Var
...
Begin
    Try
        ...
        NewPcbLibComp := CreateAComponent('DB9_F_TH_RA_TE2301844');
        NewPcbLibComp.Name := 'DB9_F_TH_RA_TE2301844';
        NewPCBLibComp.Description := 'Connectors, Interconnects / D-Sub, D-Shaped Connectors / D-Sub Connector / TE Connectivity 2301844-1; 9 pin, 30.81 mm L X 20.65 mm W X 13.575 mm H body; 9 pin, 30.81 mm L X 20.65 mm W X 13.575 mm H body';
        NewPCBLibComp.Height := MMsToCoord(13.575);
        ...
        CreateTHComponentPad(NewPCBLibComp, '1', eRoundHole, 0.9, 0, eBottomLayer, 5.54, 8.645, 0, 0, eRectangular, 1.35, 1.35, eRounded, 1.35, 1.35, eRectangular, 1.35, 1.35, 0, 0, -1.35, 0, True);
        CreateTHComponentPad(NewPCBLibComp, '2', eRoundHole, 0.9, 0, eBottomLayer, 2.77, 8.645, 0, 0, eRounded, 1.4, 1.4, eRounded, 1.4, 1.4, eRounded, 1.4, 1.4, 0, 0, -1.4, 0, True);
        CreateTHComponentPad(NewPCBLibComp, '3', eRoundHole, 0.9, 0, eBottomLayer, 0, 8.645, 0, 0, eRounded, 1.4, 1.4, eRounded, 1.4, 1.4, eRounded, 1.4, 1.4, 0, 0, -1.4, 0, True);
        CreateTHComponentPad(NewPCBLibComp, '4', eRoundHole, 0.9, 0, eBottomLayer, -2.77, 8.645, 0, 0, eRounded, 1.4, 1.4, eRounded, 1.4, 1.4, eRounded, 1.4, 1.4, 0, 0, -1.4, 0, True);
        CreateTHComponentPad(NewPCBLibComp, '5', eRoundHole, 0.9, 0, eBottomLayer, -5.54, 8.645, 0, 0, eRounded, 1.4, 1.4, eRounded, 1.4, 1.4, eRounded, 1.4, 1.4, 0, 0, -1.4, 0, True);
        CreateTHComponentPad(NewPCBLibComp, '6', eRoundHole, 0.9, 0, eBottomLayer, 4.15, 6.105, 0, 0, eRounded, 1.4, 1.4, eRounded, 1.4, 1.4, eRounded, 1.4, 1.4, 0, 0, -1.4, 0, True);
        CreateTHComponentPad(NewPCBLibComp, '7', eRoundHole, 0.9, 0, eBottomLayer, 1.38, 6.105, 0, 0, eRounded, 1.4, 1.4, eRounded, 1.4, 1.4, eRounded, 1.4, 1.4, 0, 0, -1.4, 0, True);
        CreateTHComponentPad(NewPCBLibComp, '8', eRoundHole, 0.9, 0, eBottomLayer, -1.39, 6.105, 0, 0, eRounded, 1.4, 1.4, eRounded, 1.4, 1.4, eRounded, 1.4, 1.4, 0, 0, -1.4, 0, True);
        CreateTHComponentPad(NewPCBLibComp, '9', eRoundHole, 0.9, 0, eBottomLayer, -4.16, 6.105, 0, 0, eRounded, 1.4, 1.4, eRounded, 1.4, 1.4, eRounded, 1.4, 1.4, 0, 0, -1.4, 0, True);
        CreateTHComponentPad(NewPCBLibComp, 'MH1', eRoundHole, 3.2, 0, eBottomLayer, -12.495, 7.375, 0, 0, eRounded, 1, 1, eRounded, 1, 1, eRounded, 1, 1, 0, 0, -1, 1.1, False);
        CreateTHComponentPad(NewPCBLibComp, 'MH2', eRoundHole, 3.2, 0, eBottomLayer, 12.495, 7.375, 0, 0, eRounded, 1, 1, eRounded, 1, 1, eRounded, 1, 1, 0, 0, -1, 1.1, False);

        CreateComponentArc(NewPCBLibComp, -12.495, 7.375, 2.11, 0, 360, eKeepOutLayer, 0.025, True);
        CreateComponentArc(NewPCBLibComp, 12.495, 7.375, 2.11, 0, 360, eKeepOutLayer, 0.025, True);
        CreateComponentTrack(NewPCBLibComp, -15.405, -10.325, -15.405, 10.325, ILayer.MechanicalLayer(21), 0.025, False);
        CreateComponentTrack(NewPCBLibComp, -15.405, 10.325, 15.405, 10.325, ILayer.MechanicalLayer(21), 0.025, False);
        CreateComponentTrack(NewPCBLibComp, 15.405, 10.325, 15.405, -10.325, ILayer.MechanicalLayer(21), 0.025, False);
        CreateComponentTrack(NewPCBLibComp, 15.405, -10.325, -15.405, -10.325, ILayer.MechanicalLayer(21), 0.025, False);
        CreateComponentTrack(NewPCBLibComp, -15.405, -10.325, -15.405, 10.325, eMechanical9, 0.12, False);
        CreateComponentTrack(NewPCBLibComp, -15.405, 10.325, 15.405, 10.325, eMechanical9, 0.12, False);
        CreateComponentTrack(NewPCBLibComp, 15.405, 10.325, 15.405, -10.325, eMechanical9, 0.12, False);
        CreateComponentTrack(NewPCBLibComp, 15.405, -10.325, -15.405, -10.325, eMechanical9, 0.12, False);
        CreateComponentTrack(NewPCBLibComp, -15.48, -10.4, -15.48, 10.4, eTopOverlay, 0.15, False);
        CreateComponentTrack(NewPCBLibComp, -15.48, 10.4, 15.48, 10.4, eTopOverlay, 0.15, False);
        CreateComponentTrack(NewPCBLibComp, 15.48, 10.4, 15.48, -10.4, eTopOverlay, 0.15, False);
        CreateComponentTrack(NewPCBLibComp, 15.48, -10.4, -15.48, -10.4, eTopOverlay, 0.15, False);
        ...
        CreateComponentTrack(NewPCBLibComp, -15.655, -10.575, 15.655, -10.575, eMechanical15, 0.05, False);
        CreateComponentTrack(NewPCBLibComp, 15.655, -10.575, 15.655, 10.575, eMechanical15, 0.05, False);
        CreateComponentTrack(NewPCBLibComp, 15.655, 10.575, -15.655, 10.575, eMechanical15, 0.05, False);
        CreateComponentTrack(NewPCBLibComp, -15.655, 10.575, -15.655, -10.575, eMechanical15, 0.05, False);
...
Begin
    ...
    CreateComponentDB9_F_TH_RA_TE2301844(0);
