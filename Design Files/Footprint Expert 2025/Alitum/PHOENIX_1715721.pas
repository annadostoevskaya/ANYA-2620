...
Procedure CreateComponentPHOENIX_1715721(Zero : integer);
Var
...
Begin
    Try
        ...
        NewPcbLibComp := CreateAComponent('PHOENIX_1715721');
        NewPcbLibComp.Name := 'PHOENIX_1715721';
        NewPCBLibComp.Description := 'Connectors, Interconnects / Terminal Blocks / Wire to Board / Phoenix Contact 1715721; 2 pin, 10.00 mm L X 9.80 mm W X 13.80 mm H body';
        NewPCBLibComp.Height := MMsToCoord(13.8);
        ...
        CreateTHComponentPad(NewPCBLibComp, '1', eRoundHole, 1.3, 0, eBottomLayer, -2.54, -0.3, 0, 0, eRectangular, 1.95, 1.95, eRounded, 1.95, 1.95, eRectangular, 1.95, 1.95, 0, 0, -1.95, 0, True);
        CreateTHComponentPad(NewPCBLibComp, '2', eRoundHole, 1.3, 0, eBottomLayer, 2.54, -0.3, 0, 0, eRounded, 1.95, 1.95, eRounded, 1.95, 1.95, eRounded, 1.95, 1.95, 0, 0, -1.95, 0, True);

        CreateComponentTrack(NewPCBLibComp, -5.08, -4.9, -5.08, 4.9, ILayer.MechanicalLayer(21), 0.025, False);
        CreateComponentTrack(NewPCBLibComp, -5.08, 4.9, 5.08, 4.9, ILayer.MechanicalLayer(21), 0.025, False);
        CreateComponentTrack(NewPCBLibComp, 5.08, 4.9, 5.08, -4.9, ILayer.MechanicalLayer(21), 0.025, False);
        CreateComponentTrack(NewPCBLibComp, 5.08, -4.9, -5.08, -4.9, ILayer.MechanicalLayer(21), 0.025, False);
        CreateComponentTrack(NewPCBLibComp, -5.08, -4.9, -5.08, 4.9, eMechanical9, 0.12, False);
        CreateComponentTrack(NewPCBLibComp, -5.08, 4.9, 5.08, 4.9, eMechanical9, 0.12, False);
        CreateComponentTrack(NewPCBLibComp, 5.08, 4.9, 5.08, -4.9, eMechanical9, 0.12, False);
        CreateComponentTrack(NewPCBLibComp, 5.08, -4.9, -5.08, -4.9, eMechanical9, 0.12, False);
        CreateComponentTrack(NewPCBLibComp, -5.155, 4.975, 5.155, 4.975, eTopOverlay, 0.15, False);
        CreateComponentTrack(NewPCBLibComp, -5.155, -4.975, 5.155, -4.975, eTopOverlay, 0.15, False);
        CreateComponentTrack(NewPCBLibComp, -5.155, -4.975, -5.155, 4.975, eTopOverlay, 0.15, False);
        CreateComponentTrack(NewPCBLibComp, 5.155, -4.975, 5.155, 4.975, eTopOverlay, 0.15, False);
        ...
        CreateComponentTrack(NewPCBLibComp, -5.33, -5.15, 5.33, -5.15, eMechanical15, 0.05, False);
        CreateComponentTrack(NewPCBLibComp, 5.33, -5.15, 5.33, 5.15, eMechanical15, 0.05, False);
        CreateComponentTrack(NewPCBLibComp, 5.33, 5.15, -5.33, 5.15, eMechanical15, 0.05, False);
        CreateComponentTrack(NewPCBLibComp, -5.33, 5.15, -5.33, -5.15, eMechanical15, 0.05, False);
...
Begin
    ...
    CreateComponentPHOENIX_1715721(0);
