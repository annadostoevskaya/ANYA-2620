...
Procedure CreateComponentR0603M(Zero : integer);
Var
...
Begin
    Try
        ...
        NewPcbLibComp := CreateAComponent('R0603M');
        NewPcbLibComp.Name := 'R0603M';
        NewPCBLibComp.Description := 'Resistor, Chip; 1.60 mm L X 0.775 mm W X 0.55 mm H body';
        ...
        CreateSMDComponentPad(NewPCBLibComp, '1', eTopLayer, -0.8, 0, 0, 0, eRoundedRectangular, 0.9, 1, 180, 22.22, 0, 0, True, True);
        CreateSMDComponentPad(NewPCBLibComp, '2', eTopLayer, 0.8, 0, 0, 0, eRoundedRectangular, 0.9, 1, 0, 22.22, 0, 0, True, True);

        CreateComponentTrack(NewPCBLibComp, -0.5, 0.3875, -0.5, -0.3875, ILayer.MechanicalLayer(21), 0.025, False);
        CreateComponentTrack(NewPCBLibComp, -0.5, -0.3875, -0.8, -0.3875, ILayer.MechanicalLayer(21), 0.025, False);
        CreateComponentTrack(NewPCBLibComp, -0.8, -0.3875, -0.8, 0.3875, ILayer.MechanicalLayer(21), 0.025, False);
        CreateComponentTrack(NewPCBLibComp, -0.8, 0.3875, -0.5, 0.3875, ILayer.MechanicalLayer(21), 0.025, False);
        CreateComponentTrack(NewPCBLibComp, 0.5, -0.3875, 0.5, 0.3875, ILayer.MechanicalLayer(21), 0.025, False);
        CreateComponentTrack(NewPCBLibComp, 0.5, 0.3875, 0.8, 0.3875, ILayer.MechanicalLayer(21), 0.025, False);
        CreateComponentTrack(NewPCBLibComp, 0.8, 0.3875, 0.8, -0.3875, ILayer.MechanicalLayer(21), 0.025, False);
        CreateComponentTrack(NewPCBLibComp, 0.8, -0.3875, 0.5, -0.3875, ILayer.MechanicalLayer(21), 0.025, False);
        ...
        CreateComponentTrack(NewPCBLibComp, 0.85, 0.45, 0.85, -0.45, eMechanical9, 0.12, False);
        CreateComponentTrack(NewPCBLibComp, 0.85, -0.45, -0.85, -0.45, eMechanical9, 0.12, False);
        CreateComponentTrack(NewPCBLibComp, -1.65, -0.9, -1.65, 0.9, eMechanical15, 0.05, False);
        CreateComponentTrack(NewPCBLibComp, -1.65, 0.9, 1.65, 0.9, eMechanical15, 0.05, False);
        CreateComponentTrack(NewPCBLibComp, 1.65, 0.9, 1.65, -0.9, eMechanical15, 0.05, False);
        CreateComponentTrack(NewPCBLibComp, 1.65, -0.9, -1.65, -0.9, eMechanical15, 0.05, False);
