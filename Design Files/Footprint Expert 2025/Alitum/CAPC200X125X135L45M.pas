...
Procedure CreateComponentCAPC200X125X135L45M(Zero : integer);
Var
...
Begin
    Try
        ...
        NewPcbLibComp := CreateAComponent('CAPC200X125X135L45M');
        NewPcbLibComp.Name := 'CAPC200X125X135L45M';
        NewPCBLibComp.Description := 'Capacitor, Chip; 2.00 mm L X 1.25 mm W X 1.35 mm H body';
        ...
        TextObj.Size := MMsToCoord(1.5);
        TextObj.Width := MMsToCoord(0.15);
        ...
        CreateSMDComponentPad(NewPCBLibComp, '1', eTopLayer, -0.908, 0, 0, 0, eRoundedRectangular, 1.08, 1.45, 180, 18.52, 0, 0, True, True);
        CreateSMDComponentPad(NewPCBLibComp, '2', eTopLayer, 0.908, 0, 0, 0, eRoundedRectangular, 1.08, 1.45, 0, 18.52, 0, 0, True, True);

        CreateComponentTrack(NewPCBLibComp, -0.55, 0.625, -0.55, -0.625, ILayer.MechanicalLayer(21), 0.025, False);
        CreateComponentTrack(NewPCBLibComp, -0.55, -0.625, -1, -0.625, ILayer.MechanicalLayer(21), 0.025, False);
        CreateComponentTrack(NewPCBLibComp, -1, -0.625, -1, 0.625, ILayer.MechanicalLayer(21), 0.025, False);
        CreateComponentTrack(NewPCBLibComp, -1, 0.625, -0.55, 0.625, ILayer.MechanicalLayer(21), 0.025, False);
        CreateComponentTrack(NewPCBLibComp, 0.55, -0.625, 0.55, 0.625, ILayer.MechanicalLayer(21), 0.025, False);
        CreateComponentTrack(NewPCBLibComp, 0.55, 0.625, 1, 0.625, ILayer.MechanicalLayer(21), 0.025, False);
        CreateComponentTrack(NewPCBLibComp, 1, 0.625, 1, -0.625, ILayer.MechanicalLayer(21), 0.025, False);
        CreateComponentTrack(NewPCBLibComp, 1, -0.625, 0.55, -0.625, ILayer.MechanicalLayer(21), 0.025, False);
        ...
        CreateComponentTrack(NewPCBLibComp, 1.05, 0.675, 1.05, -0.675, eMechanical9, 0.12, False);
        CreateComponentTrack(NewPCBLibComp, 1.05, -0.675, -1.05, -0.675, eMechanical9, 0.12, False);
        CreateComponentTrack(NewPCBLibComp, -1.85, -1.125, -1.85, 1.125, eMechanical15, 0.05, False);
        CreateComponentTrack(NewPCBLibComp, -1.85, 1.125, 1.85, 1.125, eMechanical15, 0.05, False);
        CreateComponentTrack(NewPCBLibComp, 1.85, 1.125, 1.85, -1.125, eMechanical15, 0.05, False);
        CreateComponentTrack(NewPCBLibComp, 1.85, -1.125, -1.85, -1.125, eMechanical15, 0.05, False);
        ...
        CreateComponentTrack(NewPCBLibComp, -0.583, -1.025, -1.75, -1.025, eTopOverlay, 0.2, False);
        CreateComponentTrack(NewPCBLibComp, -1.75, -1.025, -1.75, 1.025, eTopOverlay, 0.2, False);
        CreateComponentTrack(NewPCBLibComp, -1.75, 1.025, -0.583, 1.025, eTopOverlay, 0.2, False);
        CreateComponentTrack(NewPCBLibComp, 0.583, -1.025, 1.75, -1.025, eTopOverlay, 0.2, False);
        CreateComponentTrack(NewPCBLibComp, 1.75, -1.025, 1.75, 1.025, eTopOverlay, 0.2, False);
        CreateComponentTrack(NewPCBLibComp, 1.75, 1.025, 0.583, 1.025, eTopOverlay, 0.2, False);
...
Begin
    ...
    CreateComponentCAPC200X125X135L45M(0);
