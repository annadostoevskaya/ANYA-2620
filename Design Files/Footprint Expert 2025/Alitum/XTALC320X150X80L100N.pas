...
Procedure CreateComponentXTALC320X150X80L100N(Zero : integer);
Var
...
Begin
    Try
        ...
        NewPcbLibComp := CreateAComponent('XTALC320X150X80L100N');
        NewPcbLibComp.Name := 'XTALC320X150X80L100N';
        NewPCBLibComp.Description := 'Crystal, Chip; 3.20 mm L X 1.50 mm W X 0.80 mm H body';
        ...
        TextObj2.Size := MMsToCoord(1.12);
        TextObj2.Width := MMsToCoord(0.11);
        ...
        CreateSMDComponentPad(NewPCBLibComp, '1', eTopLayer, -1.275, 0, 0, 0, eRoundedRectangular, 1.45, 1.6, 180, 13.79, 0, 0, True, True);
        CreateSMDComponentPad(NewPCBLibComp, '2', eTopLayer, 1.275, 0, 0, 0, eRoundedRectangular, 1.45, 1.6, 0, 13.79, 0, 0, True, True);

        CreateComponentTrack(NewPCBLibComp, -0.6, 0.75, -0.6, -0.75, ILayer.MechanicalLayer(21), 0.025, False);
        CreateComponentTrack(NewPCBLibComp, -0.6, -0.75, -1.6, -0.75, ILayer.MechanicalLayer(21), 0.025, False);
        CreateComponentTrack(NewPCBLibComp, -1.6, -0.75, -1.6, 0.75, ILayer.MechanicalLayer(21), 0.025, False);
        CreateComponentTrack(NewPCBLibComp, -1.6, 0.75, -0.6, 0.75, ILayer.MechanicalLayer(21), 0.025, False);
        CreateComponentTrack(NewPCBLibComp, 0.6, -0.75, 0.6, 0.75, ILayer.MechanicalLayer(21), 0.025, False);
        CreateComponentTrack(NewPCBLibComp, 0.6, 0.75, 1.6, 0.75, ILayer.MechanicalLayer(21), 0.025, False);
        CreateComponentTrack(NewPCBLibComp, 1.6, 0.75, 1.6, -0.75, ILayer.MechanicalLayer(21), 0.025, False);
        CreateComponentTrack(NewPCBLibComp, 1.6, -0.75, 0.6, -0.75, ILayer.MechanicalLayer(21), 0.025, False);
        ...
        CreateComponentTrack(NewPCBLibComp, 1.6, 0.75, 1.6, -0.75, ILayer.MechanicalLayer(21), 0.025, False);
        CreateComponentTrack(NewPCBLibComp, 1.6, -0.75, -1.6, -0.75, ILayer.MechanicalLayer(21), 0.025, False);
        CreateComponentTrack(NewPCBLibComp, -1.65, -0.8, -1.65, 0.8, eMechanical9, 0.12, False);
        CreateComponentTrack(NewPCBLibComp, -1.65, 0.8, 1.65, 0.8, eMechanical9, 0.12, False);
        CreateComponentTrack(NewPCBLibComp, 1.65, 0.8, 1.65, -0.8, eMechanical9, 0.12, False);
        CreateComponentTrack(NewPCBLibComp, 1.65, -0.8, -1.65, -0.8, eMechanical9, 0.12, False);
        CreateComponentTrack(NewPCBLibComp, -0.325, 0.875, 0.325, 0.875, eTopOverlay, 0.15, False);
        CreateComponentTrack(NewPCBLibComp, -0.325, -0.875, 0.325, -0.875, eTopOverlay, 0.15, False);
        CreateComponentTrack(NewPCBLibComp, -2.2, -1, -2.2, 1, eMechanical15, 0.05, False);
        CreateComponentTrack(NewPCBLibComp, -2.2, 1, 2.2, 1, eMechanical15, 0.05, False);
        CreateComponentTrack(NewPCBLibComp, 2.2, 1, 2.2, -1, eMechanical15, 0.05, False);
        CreateComponentTrack(NewPCBLibComp, 2.2, -1, -2.2, -1, eMechanical15, 0.05, False);
...
Begin
    ...
    CreateComponentXTALC320X150X80L100N(0);
