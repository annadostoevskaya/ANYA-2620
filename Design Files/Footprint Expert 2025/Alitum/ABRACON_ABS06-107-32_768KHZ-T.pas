...
Procedure CreateComponentABRACON_ABS06_107_32_768KHZ_T(Zero : integer);
Var
...
Begin
    Try
        ...
        NewPcbLibComp := CreateAComponent('ABRACON_ABS06-107-32_768KHZ-T');
        NewPcbLibComp.Name := 'ABRACON_ABS06-107-32_768KHZ-T';
        NewPCBLibComp.Description := 'Crystals; 2 pin, 2.00 mm L X 1.20 mm W X 0.60 mm H body';
        ...
        TextObj2.Size := MMsToCoord(0.72);
        TextObj2.Width := MMsToCoord(0.07);
        ...
        CreateSMDComponentPad(NewPCBLibComp, '1', eTopLayer, -0.725, 0, 0, 0, eRectangular, 0.75, 1.4, 0, 0, 0, 0, True, True);
        CreateSMDComponentPad(NewPCBLibComp, '2', eTopLayer, 0.725, 0, 0, 0, eRectangular, 0.75, 1.4, 0, 0, 0, 0, True, True);

        CreateComponentTrack(NewPCBLibComp, -1, -0.6, -1, 0.6, ILayer.MechanicalLayer(21), 0.025, False);
        CreateComponentTrack(NewPCBLibComp, -1, 0.6, 1, 0.6, ILayer.MechanicalLayer(21), 0.025, False);
        CreateComponentTrack(NewPCBLibComp, 1, 0.6, 1, -0.6, ILayer.MechanicalLayer(21), 0.025, False);
        CreateComponentTrack(NewPCBLibComp, 1, -0.6, -1, -0.6, ILayer.MechanicalLayer(21), 0.025, False);
        CreateComponentTrack(NewPCBLibComp, -1, -0.6, -1, 0.6, eMechanical9, 0.12, False);
        CreateComponentTrack(NewPCBLibComp, -1, 0.6, 1, 0.6, eMechanical9, 0.12, False);
        CreateComponentTrack(NewPCBLibComp, 1, 0.6, 1, -0.6, eMechanical9, 0.12, False);
        CreateComponentTrack(NewPCBLibComp, 1, -0.6, -1, -0.6, eMechanical9, 0.12, False);
        CreateComponentTrack(NewPCBLibComp, -1.325, -0.925, -1.325, 0.925, eTopOverlay, 0.15, False);
        CreateComponentTrack(NewPCBLibComp, -1.325, 0.925, 1.325, 0.925, eTopOverlay, 0.15, False);
        CreateComponentTrack(NewPCBLibComp, 1.325, 0.925, 1.325, -0.925, eTopOverlay, 0.15, False);
        CreateComponentTrack(NewPCBLibComp, 1.325, -0.925, -1.325, -0.925, eTopOverlay, 0.15, False);
        ...
        CreateComponentTrack(NewPCBLibComp, -1.4, -1, 1.4, -1, eMechanical15, 0.05, False);
        CreateComponentTrack(NewPCBLibComp, 1.4, -1, 1.4, 1, eMechanical15, 0.05, False);
        CreateComponentTrack(NewPCBLibComp, 1.4, 1, -1.4, 1, eMechanical15, 0.05, False);
        CreateComponentTrack(NewPCBLibComp, -1.4, 1, -1.4, -1, eMechanical15, 0.05, False);
...
Begin
    ...
    CreateComponentABRACON_ABS06_107_32_768KHZ_T(0);
